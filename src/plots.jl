...
# Plot setup
shp_path = "/home/raf/.julia/dev/MethodsPaper/data/ausborder_polyline.shp"
...
map(p -> plot!(p, shp.shapes; shape_opts...), (p1, p2))
...
map(p -> plot!(p, shp.shapes; shape_opts...), (p3, p4, p5))
